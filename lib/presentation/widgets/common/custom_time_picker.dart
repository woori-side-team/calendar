...
TextStyle _themeTextStyle(BuildContext context,
    {bool isValid = true, double? fontSize}) {
...
class CustomCupertinoDatePicker extends StatefulWidget {
  ...
  static double _getColumnWidth(_PickerColumnType columnType,
      CupertinoLocalizations localizations, BuildContext context,
      {double? fontSize}) {
    String longestText = '';
    ...
    final TextPainter painter = TextPainter(
      text: TextSpan(
        style: _themeTextStyle(context, fontSize: fontSize),
        text: longestText,
      ),
      ...
      child: CupertinoPicker.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return itemPositioningBuilder(
            context,
            Text(dateText, style: _themeTextStyle(context, fontSize: widget.fontSize)),
          );
        },
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context,
                  isValid: _isValidHour(selectedAmPm, index), fontSize: widget.fontSize),
            ),
          );
        }),
      ),
        ...
        children:
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context, isValid: !isInvalidMinute, fontSize: widget.fontSize),
            ),
          );
        }),
      ),
        ...
        children: List<Widget>.generate(2, (int index) {
          return itemPositioningBuilder(
            ...
            Text(
              index == 0 ? '오전' : '오후',
              style: _themeTextStyle(context,
                  isValid: _isValidHour(index, _selectedHourIndex), fontSize: widget.fontSize),
            ),
          );
        }),
      ),
        ...
        children: List<Widget>.generate(31, (int index) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style:
                  _themeTextStyle(context, isValid: day <= daysInCurrentMonth, fontSize: widget.fontSize),
            ),
          );
        }),
      ),
        ...
        children: List<Widget>.generate(12, (int index) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context, isValid: !isInvalidMonth, fontSize: widget.fontSize),
            ),
          );
        }),
      ),
        ...
        itemBuilder: (BuildContext context, int year) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context, isValid: isValidYear, fontSize: widget.fontSize),
            ),
          );
        },
        selectionOverlay: selectionOverlay,
