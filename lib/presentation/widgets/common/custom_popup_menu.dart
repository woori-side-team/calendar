...
/// To show a popup menu, use the [showCustomMenu] function. To create a button that
...
///  * [showCustomMenu], a method to dynamically show a popup menu at a given location.
...
abstract class PopupMenuEntry<T> extends StatefulWidget {
  ...
  ///
  /// This value is used at the time the [showCustomMenu] method is called, if the
  ...
  ///
  /// This method is used by [showCustomMenu], when it is called, to align the entry
...
class PopupMenuItem<T> extends PopupMenuEntry<T> {
  ...
  /// The value that will be returned by [showCustomMenu] if this entry is selected.
  final T? value;
