...
class SchedulesProvider extends ChangeNotifier {
  final _schedules = <Schedule>[
    ...
    Schedule(
        ...
        start: DateTime(2022, 10, 1, 14 - 1),
        end: DateTime(2022, 10, 1, 15 - 1),
        colorIndex: 0),
    Schedule(
        tag: '업무',
        content: '가족 모임',
        type: ScheduleType.hours,
        start: DateTime(2022, 10, 1, 16 - 1),
        end: DateTime(2022, 10, 1, 17 - 1, 30),
        colorIndex: 1),
    Schedule(
        tag: '업무',
        content: '매니저님에게 기획서 전달',
        type: ScheduleType.hours,
        start: DateTime(2022, 10, 1, 17 - 1),
        end: DateTime(2022, 10, 1, 18 - 1, 30),
        colorIndex: 2),
    Schedule(
        tag: '개인',
        content: '기타 연습하기',
        type: ScheduleType.hours,
        start: DateTime(2022, 10, 4, 17 - 1),
        end: DateTime(2022, 10, 4, 18 - 1, 30),
        colorIndex: 2),
    Schedule(
        tag: '개인',
        content: '피아노 연습하기',
    ...
    Schedule(
        ...
        content: 'Vue 공부하기',
        type: ScheduleType.hours,
        start: DateTime(2022, 10, 25, 17 - 1),
        end: DateTime(2022, 10, 25, 18 - 1, 30),
        colorIndex: 4),
    Schedule(
        tag: '개인',
        content: 'Svelte 공부하기',
        type: ScheduleType.hours,
        start: DateTime(2022, 10, 25, 17 - 1, 30),
        end: DateTime(2022, 10, 25, 18 - 1, 30),
        colorIndex: 3),
    Schedule(
        tag: '개인',
