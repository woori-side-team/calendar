...
void main() {
  test('command test', () {
    ...
    expect(DateTime(2023, 3, 3, 15, 14),
        ScheduleCommandUtils.getStartDateTimeWithFullForm('2023-3-3 15시 14'));
    expect(DateTime(2023, 3, 3, 15),
        ScheduleCommandUtils.getStartDateTimeWithFullForm('2023-3-3 15시'));
    expect(
        null, ScheduleCommandUtils.getStartDateTimeWithFullForm('202-3-3 15시'));
    expect(DateTime(2023, 11, 11),
        ScheduleCommandUtils.getStartDateTimeWithoutYear('11월 11일'));
    expect(DateTime(2023, 1, 11),
        ScheduleCommandUtils.getStartDateTimeWithoutYearAndMonth('11일'));
    ...
    final endTime = ScheduleCommandUtils.getEndDateTimeWithNumberAndBlank(
        '2020 2 2', DateTime(2020, 2, 1));
    expect(2, endTime?.day);
  });
}
